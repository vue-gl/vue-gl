...
import { Vector3, Euler, Spherical, Object3D, Scene, Camera, WebGLRenderer, PerspectiveCamera, Group, Light, DirectionalLight, AmbientLight, Material, PointsMaterial, BufferGeometry, SphereBufferGeometry, MeshStandardMaterial, Mesh, Points, LineBasicMaterial, Line, Sprite, BoxBufferGeometry, CircleBufferGeometry, LineSegments, LineLoop, CylinderBufferGeometry, ConeBufferGeometry, AxesHelper, OrthographicCamera, PlaneBufferGeometry, DodecahedronBufferGeometry, IcosahedronBufferGeometry, OctahedronBufferGeometry, RingBufferGeometry, TetrahedronBufferGeometry, TorusBufferGeometry, TorusKnotBufferGeometry, ArrowHelper, Color, BoxHelper, PointLight, SpotLight, TextureLoader, ExtrudeGeometry, TextBufferGeometry, FontLoader, SpriteMaterial, GridHelper, ShadowMaterial, CameraHelper, DirectionalLightHelper } from 'https://unpkg.com/three@0.90.0/build/three.module.js';
...
function parseVector3(str) {
  return str.isVector3 ? str : new (Function.prototype.bind.apply(Vector3, [null].concat(toConsumableArray(str.trim().split(/\s+/).map(function (elm) {
...
function parseEuler(str) {
  return str.isEuler ? str : new (Function.prototype.bind.apply(Euler, [null].concat(toConsumableArray(str.trim().split(/\s+/).map(function (elm, i) {
...
function parseSpherical(str) {
  return str.isSpherical ? str : new (Function.prototype.bind.apply(Spherical, [null].concat(toConsumableArray(str.trim().split(/\s+/).map(function (elm) {
    return parseFloat(elm);
  })))))().makeSafe();
}
...
var vglSphereGeometry = {
  ...
  computed: {
    inst: function inst() {
      return new SphereBufferGeometry(parseFloat(this.radius), parseInt(this.widthSegments, 10), parseInt(this.heightSegments, 10), parseFloat(this.phiStart), parseFloat(this.phiLength), parseFloat(this.thetaStart), parseFloat(this.thetaLength));
    }
  }
};
...
var vglBoxGeometry = {
  ...
  computed: {
    inst: function inst() {
      return new BoxBufferGeometry(parseFloat(this.width), parseFloat(this.height), parseFloat(this.depth), parseInt(this.widthSegments, 10), parseInt(this.heightSegments, 10), parseInt(this.depthSegments, 10));
    }
  }
};
...
var vglCircleGeometry = {
  ...
  computed: {
    inst: function inst() {
      return new CircleBufferGeometry(parseFloat(this.radius), parseInt(this.segments, 10), parseFloat(this.thetaStart), parseFloat(this.thetaLength));
    }
  }
};
...
var VglCylinderGeometry = {
  ...
  computed: {
    inst: function inst() {
      return new CylinderBufferGeometry(parseFloat(this.radiusTop), parseFloat(this.radiusBottom), parseFloat(this.height), parseInt(this.radialSegments, 10), parseInt(this.heightSegments, 10), this.openEnded, parseFloat(this.thetaStart), parseFloat(this.thetaLength));
    }
  }
};
...
var vglConeGeometry = {
  ...
  computed: {
    inst: function inst() {
      return new ConeBufferGeometry(parseFloat(this.radius), parseFloat(this.height), parseInt(this.radialSegments, 10), parseInt(this.heightSegments, 10), this.openEnded, parseFloat(this.thetaStart), parseFloat(this.thetaLength));
    }
  }
};
...
var vglPlaneGeometry = {
  ...
  computed: {
    inst: function inst() {
      return new PlaneBufferGeometry(parseFloat(this.width), parseFloat(this.height), parseInt(this.widthSegments, 10), parseInt(this.heightSegments, 10));
    }
  }
};
...
var vglRingGeometry = {
  ...
  computed: {
    inst: function inst() {
      return new RingBufferGeometry(parseFloat(this.innerRadius), parseFloat(this.outerRadius), parseInt(this.thetaSegments, 10), parseInt(this.phiSegments, 10), parseFloat(this.thetaStart), parseFloat(this.thetaLength));
    }
  }
};
...
var vglTorusGeometry = {
  ...
  computed: {
    inst: function inst() {
      return new TorusBufferGeometry(parseFloat(this.radius), parseFloat(this.tube), parseInt(this.radialSegments, 10), parseInt(this.tubularSegments, 10), parseFloat(this.arc));
    }
  }
};
...
var vglTorusKnotGeometry = {
  ...
  computed: {
    inst: function inst() {
      return new TorusKnotBufferGeometry(parseFloat(this.radius), parseFloat(this.tube), parseInt(this.tubularSegments, 10), parseInt(this.radialSegments, 10), parseInt(this.p, 10), parseInt(this.q, 10));
    }
  }
};
...
var vglArrowHelper = {
  ...
  computed: {
    inst: function inst() {
      return new ArrowHelper(new Vector3(0, 1, 0), new Vector3());
    },
    len: function len() {
  ...
  watch: {
    ...
    color: function color(_color) {
      this.inst.setColor(new Color(_color));
    }
  }
};
  ...
  watch: {
    src: {
      handler: function handler(src) {
        ...
        new TextureLoader().load(src, function (texture) {
        ...
        if (!fonts[src]) {
          ...
          if (!/^data:.*?(?:;base64)?,.*$/.test(src)) {
            ...
            xhr.addEventListener('load', function () {
              new FontLoader().load('data:,' + encodeURIComponent(xhr.responseText), function (font) {
                var queue = fonts[src];
                fonts[src] = font;
            ...
            new FontLoader().load(src, function (font) {
              var queue = fonts[src];
              fonts[src] = font;
              queue.forEach(function (f) {
                f();
...
var vglGridHelper = {
  ...
  computed: {
    inst: function inst() {
      return new GridHelper(parseFloat(this.size), parseInt(this.divisions, 10), this.colorCenterLine, this.colorGrid);
    }
  }
};
...
var vglCameraHelper = {
  ...
  computed: {
    inst: function inst() {
      ...
      var helper = new CameraHelper(new Camera());
...
var vglDirectionalLightHelper = {
  ...
  watch: {
    ...
    size: function size(_size) {
      if (this.i.parent) {
        this.i = new DirectionalLightHelper(this.i.parent, parseFloat(_size), this.color);
      }
    }
  }
};
