describe('VglPointLight:', function component() {
  ...
  it('with distance property', function test(done) {
    const vm = new Vue({
  ...
  it('with decay property', function test(done) {
    const vm = new Vue({
  ...
  it('after distance property is changed', function test(done) {
    const vm = new Vue({
  ...
  it('after decay property is changed', function test(done) {
    const vm = new Vue({
