describe('VglCamera component', function component() {
  ...
  describe('Orbit properties should overwrite the position and the rotation properties.', function suite() {
    describe('When only the orbitPosition property is defined.', function when() {
      it('The position should be defined by spherical system around origin.', function test(done) {
        const vm = new Vue({
      ...
      it('The instance should be looking at origin.', function test(done) {
        const vm = new Vue({
    ...
    describe('When only the orbitTarget is defined.', function when() {
      it('The position should be the origin.', function test(done) {
        const vm = new Vue({
      ...
      it('The instance should be looking at target from origin.', function test(done) {
        const vm = new Vue({
      ...
      it('The position property should affect the position if the property is defined.', function test(done) {
        const vm = new Vue({
      ...
      it('The instance should be looking at target from the position if the position property is defined.', function test(done) {
        const vm = new Vue({
          template: '<vgl-namespace><vgl-camera orbitTarget="1.8 2.2 -3" position="0.6 -8  9" ref="camera" /></vgl-namespace>',
          components: { VglCamera, VglNamespace },
        }).$mount();
    ...
    describe('When both the orbitPosition and the orbitTarget are defined.', function when() {
      it('The position should be an vector added the target vector and the vector defined by spherical system.', function test(done) {
        const vm = new Vue({
      ...
      it('The instance should be looking at the target position.', function test(done) {
        const vm = new Vue({
          template: '<vgl-namespace><vgl-camera orbitTarget="1 2 3" orbitPosition="2 1 2.9" ref="camera" /></vgl-namespace>',
          components: { VglCamera, VglNamespace },
        }).$mount();
    ...
    describe('When either the orbitPosition nor the orbitTarget are not defined.', function when() {
      it('The position and the rotation properties should affect.', function test(done) {
        const vm = new Vue({
