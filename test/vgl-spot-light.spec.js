describe('VglSpotLight component', () => {
  ...
  describe('Creating a light', () => {
    ...
    describe('The angle of the light should be same as the angle property.', () => {
      it('When the property is undefined.', () => {
        const vm = new Vue({
          template: `<mocked-renderer><vgl-spot-light ref="lit" /></mocked-renderer>`,
          components: { VglSpotLight, MockedRenderer }
    ...
    describe('The penumbra of the light should be same as the penumbra property.', () => {
      it('When the property is undefined.', () => {
        const vm = new Vue({
          template: `<mocked-renderer><vgl-spot-light ref="lit" /></mocked-renderer>`,
          components: { VglSpotLight, MockedRenderer }
    ...
    describe('The target of the light should be same as the target property.', () => {
      it('When the property is undefined.', () => {
        const vm = new Vue({
          template: `<mocked-renderer><vgl-spot-light ref="lit" /></mocked-renderer>`,
          components: { VglSpotLight, MockedRenderer }
    ...
    describe('The target object of the light should be added to the parent object.', () => {
      const { VglObject3d } = VueGL
      it('When the target property is undefined and a parent does not exist.', () => {
        const vm = new Vue({
          template: `<mocked-renderer><vgl-spot-light ref="lit" /></mocked-renderer>`,
          components: { VglSpotLight, MockedRenderer }
        }).$mount()
      ...
      it('When the target property is undefined and a parent exists.', () => {
        const vm = new Vue({
      ...
      it('When the target property is a Vector3 object and a parent does not exist.', () => {
        const vm = new Vue({
          template: `<mocked-renderer><vgl-spot-light :target="target" ref="lit" /></mocked-renderer>`,
          components: { VglSpotLight, MockedRenderer },
      ...
      it('When the target property is a Vector3 object and a parent exists.', () => {
        const vm = new Vue({
      ...
      it('When the target property is a string and a parent does not exist.', () => {
        const vm = new Vue({
  ...
  describe('Watching properties', () => {
    ...
    it('The angle of the light should change when the angle property changes.', (done) => {
      const vm = new Vue({
    ...
    it('The penumbra of the light should change when the penumbra property changes.', (done) => {
      const vm = new Vue({
    ...
    it('The target of the light should change when the target property changes.', (done) => {
      const vm = new Vue({
        template: `<mocked-renderer><vgl-spot-light :target="target" ref="lit" /></mocked-renderer>`,
        components: { VglSpotLight, MockedRenderer },
        data: { target: '-1 2 1.1' }
    ...
    it('The target object should be added to the parent object when the parent changes.', (done) => {
      const { VglObject3d } = VueGL
      const vm = new Vue({
