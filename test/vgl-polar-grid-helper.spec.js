...
import { LineSegments, PolarGridHelper } from 'three';
import { VglPolarGridHelper, VglNamespace } from '../src';
  ...
  test('without properties', (done) => {
    ...
    vm.$nextTick(() => {
      try {
        ...
        const expected = new PolarGridHelper();
    ...
    vm.$nextTick(() => {
      ...
      vm.$nextTick(() => {
        try {
          ...
          actual.material = vm.$refs.h.inst.material;
          actual.updateMatrixWorld();
          const expected = new PolarGridHelper(12, 7, 9, 19, 0xdd39f9, 0x6aa57c);
