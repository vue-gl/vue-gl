describe("VglLensFlareTexture component", function() {
    const {VglLensFlare, VglLensFlareTexture, VglTexture, VglNamespace} = VueGL;
    const assert = chai.assert;
    describe("Creating a component", function() {
        describe("Lens flare parameters", function() {
            describe("Lens flare's texture should be determined by the texture property.", function() {
                it("When the texture is existing VglTexture component's name.", function(done) {
                    const vm = new Vue({
            ...
            describe("Lens flare's size should be determined by the size property.", function() {
                it("When the size property is a string.", function(done) {
                    const vm = new Vue({
                ...
                it("When the size property is a number.", function(done) {
                    const vm = new Vue({
            ...
            describe("Lens flare's distance should be determined by the distance property.", function() {
                it("When the distance property is a string.", function(done) {
                    const vm = new Vue({
                ...
                it("When the distance property is a number.", function(done) {
                    const vm = new Vue({
            ...
            describe("Lens flare's color should be determined by the color property.", function() {
                it("When the color property is a string.", function(done) {
                    const vm = new Vue({
            ...
            describe("Lens flare's blending mode should be determined by the blending property.", function() {
                it("When the blending property is a string.", function(done) {
                    const vm = new Vue({
                ...
                it("When the blending property is a number.", function(done) {
                    const vm = new Vue({
    ...
    describe("Watching properties", function() {
        it("When the texture changes.", function(done) {
            const vm = new Vue({
        ...
        it("When the distance changes.", function(done) {
            const vm = new Vue({
        ...
        it("When the color changes.", function(done) {
            const vm = new Vue({
        ...
        it("When the blending mode changes.", function(done) {
            const vm = new Vue({
