describe('VglLensFlareTexture component', () => {
  const {
  ...
  describe('Creating a component', () => {
    describe('Lens flare parameters', () => {
      describe("Lens flare's texture should be determined by the texture property.", () => {
        it("When the texture is existing VglTexture component's name.", (done) => {
          const vm = new Vue({
      ...
      describe("Lens flare's size should be determined by the size property.", () => {
        it('When the size property is a string.', (done) => {
          const vm = new Vue({
        ...
        it('When the size property is a number.', (done) => {
          const vm = new Vue({
      ...
      describe("Lens flare's distance should be determined by the distance property.", () => {
        it('When the distance property is a string.', (done) => {
          const vm = new Vue({
        ...
        it('When the distance property is a number.', (done) => {
          const vm = new Vue({
      ...
      describe("Lens flare's color should be determined by the color property.", () => {
        it('When the color property is a string.', (done) => {
          const vm = new Vue({
      ...
      describe("Lens flare's blending mode should be determined by the blending property.", () => {
        it('When the blending property is a string.', (done) => {
          const vm = new Vue({
        ...
        it('When the blending property is a number.', (done) => {
          const vm = new Vue({
  ...
  describe('Watching properties', () => {
    it('When the texture changes.', (done) => {
      const vm = new Vue({
    ...
    it('When the texture changes to undefined.', (done) => {
      const vm = new Vue({
    ...
    it('When the distance changes.', (done) => {
      const vm = new Vue({
    ...
    it('When the color changes.', (done) => {
      const vm = new Vue({
    ...
    it('When the blending mode changes.', (done) => {
      const vm = new Vue({
