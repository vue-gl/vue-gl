describe('VglDirectionalLightHelper component', function component() {
  const { VglDirectionalLightHelper, VglDirectionalLight, VglNamespace } = VueGL;
  const { assert } = chai;
  describe('Creating a helper', function when() {
    describe('The color of the helper', function suite() {
      it('should be same as the color property.', function test(done) {
        const vm = new Vue({
      ...
      it("should be same as the light's color.", function test(done) {
        const vm = new Vue({
    ...
    describe('The visualized light should be the parent object.', function suite() {
      it('When the parent component is a VglDirectionalLight.', function test(done) {
        const vm = new Vue({
  ...
  describe('Watching properties', function suite() {
    it('The color of the helper should change when the color property changes.', function test(done) {
      const vm = new Vue({
    ...
    it('The color of the helper should change when the parent light color changes.', function test(done) {
      const vm = new Vue({
    ...
    it('The instance should be replaced when the size property changes.', function test(done) {
      const vm = new Vue({
