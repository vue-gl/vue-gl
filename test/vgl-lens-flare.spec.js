describe('VglLensFlare component', () => {
  const {
    VglLensFlare, VglLensFlareTexture, VglTexture, VglNamespace
  } = VueGL
  const assert = chai.assert
  describe('Creating an object', () => {
    it('The instance should have lens flare texture children.', (done) => {
      const vm = new Vue({
  ...
  describe('Removing a lens flare texture', () => {
    it('The lens flare texture should be removed when its component is destroyed.', (done) => {
      const vm = new Vue({
  ...
  describe('Replacing a lens flare texture', () => {
    it('The lens flare texture should be replaced when its property is changed.', (done) => {
      const vm = new Vue({
