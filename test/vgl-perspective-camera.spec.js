describe('VglPerspectiveCamera component', () => {
  ...
  describe('Creating a camera', () => {
    ...
    describe('The fov of the camera should be same as the fov property.', () => {
      it('When the property is undefined.', () => {
        const vm = new Vue({
          template: `<vgl-namespace><vgl-perspective-camera ref="camera" /></vgl-namespace>`,
          components: { VglPerspectiveCamera, VglNamespace }
  ...
  describe('Watching properties', () => {
    ...
    it('The fov of the camera should change when the fov property changes.', (done) => {
      const vm = new Vue({
