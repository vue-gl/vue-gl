describe('VglObject3d component', function component() {
  const { VglObject3d } = VueGL;
  const { assert } = chai;
  describe('Component tree', function suite() {
    it('The instance should be added to the parent when created.', function test(done) {
      const vm = new Vue({
    ...
    it('The instance under other components should be added to the nearest ancestor.', function test(done) {
      const vm = new Vue({
    ...
    it('The instance should be removed from the parent when destroyed.', function test(done) {
      const vm = new Vue({
  ...
  describe('Creating a object', function when() {
    describe('Properties of the object', function target() {
      describe('The position property should affect the position of the instance.', function suite() {
      ...
      describe('The rotation property should affect the rotation of the instance.', function suite() {
        it('When the property is undefined.', function test(done) {
          const vm = new Vue(VglObject3d);
        ...
        it('When the property is a Euler object.', function test(done) {
      ...
      describe('The scale property should affect the scale of the instance.', function suite() {
        it('When the property is undefined.', function test(done) {
          const vm = new Vue(VglObject3d);
      ...
      describe('The castShadow property should affect the castShadow of the instance.', function suite() {
      ...
      describe('The recieveShadow property should affect the recieveShadow of the instance.', function suite() {
        it('When the property is false.', function test(done) {
  ...
  describe('Watching properties', function when() {
    describe('Should affect the position of the object when the position property is changed.', function suite() {
      ...
      it('From a string to a string.', function test(done) {
    ...
    describe('Should affect the castShadow of the object when the castShadow property is changed.', function suite() {
    ...
    describe('Should affect the recieveShadow of the object when the recieveShadow property is changed.', function suite() {
      it('From false to true.', function test(done) {
        const vm = new Vue(VglObject3d);
  ...
  describe('Replacing the instance', function suite() {
    const MixedIn = {
      mixins: [VglObject3d],
      computed: {
        inst() { return this.i; },
    ...
    it('The position of the replaced object should be same as before.', function test(done) {
    ...
    it('The rotation of the replaced object should be same as before.', function test(done) {
    ...
    it('The scale of the replaced object should be same as before.', function test(done) {
    ...
    it('The replaced object should have same children as before.', function test(done) {
      const vm = new Vue({
    ...
    it('The replaced object should have the same parent as before.', function test(done) {
      const vm = new Vue({
