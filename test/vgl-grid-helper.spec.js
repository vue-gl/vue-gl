...
describe("VglGridHelper component", function() {
    const {VglGridHelper, VglNamespace} = VueGL;
    const assert = chai.assert;
    describe("Creating an object", function() {
        describe("The size of grid should be same as the size property.", function() {
        ...
        describe("The divisions of grid should be same as the divisions property.", function() {
            it("When the property is a number", function() {
                const vm = new Vue({
        ...
        describe("The color of center line should be same as the colorCenterLine property.", function() {
            it("When the property is a string", function() {
                const vm = new Vue({
        ...
        describe("The color of grid should be same as the colorGrid property.", function() {
            it("When the property is a string", function() {
                const vm = new Vue({
